...
{
    /**
     * Base temporary upload path
     *
     * @var string
     */
    public const BASE_TMP_PATH = "wysiwyg/helloworld/";
     ...
     * @var string
     */
    public const BASE_PATH = "wysiwyg/helloworld/";
    ...
    /**
     * Move file from temporary folder to final folder
     *
    ...
    /**
     * Save file to temporary media directory
     *
     * @param string $fileId
     * @return array
     * @throws LocalizedException
    ...
    /**
     * Save image from media to destination directory
     *
     * @param string $imageName
